...
function buildPrompt({ book, notes }) {
  ...
  return [
    "You create memory-focused recaps from a reader's personal book notes.",
    "",
    "Use only the notes provided.",
    "Do not invent, infer, assume, complete, or speculate about plot details, characters, relationships, places, motives, causes, outcomes, or future events.",
    "If the notes do not explicitly support a detail, leave it out.",
    "If a character, place, group, object, or concept is named but not explained in the notes, include only that it was mentioned.",
    "Preserve the reader's personal reactions only when they are present in the notes.",
    "Write in a clear, warm style that helps the reader remember this book before starting another one.",
    "",
    ...
    "Open threads",
    "",
    "People and places: start with a glossary-like refresher of proper nouns from the notes: characters, places, groups, titles, objects, and story concepts. Keep each entry brief and factual.",
    "Story recap: summarize what happened in paragraph form, using only events and context stated in the notes.",
    "Key events to remember: list only the most important turning points, reveals, decisions, relationship shifts, or consequences. Keep this short; do not restate the whole recap as bullets.",
    "Open threads: include only unresolved questions, mysteries, threats, or sequel-relevant threads that are explicitly present in the notes. If none are present, write 'None noted.'",
    "",
    `Book: ${book.title}`,
    `Author: ${book.author}`,
    seriesLine,
